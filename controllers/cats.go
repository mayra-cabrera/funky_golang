...
// @Param	body		body 	models.Cats	true		"body for Cats content"
// @Success 201 {int} models.Cats
// @Failure 403 body is empty
// @router / [post]
func (c *CatsController) Post() {
	var v models.Cats
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddCats(&v); err == nil {
...
func (c *CatsController) GetAll() {
	...
	l, err := models.GetAllCats(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = l
...
func (c *CatsController) Put() {
	...
	v := models.Cats{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateCatsById(&v); err == nil {
			c.Data["json"] = "OK"
		} else {
			c.Data["json"] = err.Error()
		}
...
func (c *CatsController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteCats(id); err == nil {
		c.Data["json"] = "OK"
	} else {
		c.Data["json"] = err.Error()
	}
